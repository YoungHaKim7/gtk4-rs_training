...
typedef struct _CameraFilePath {
    char folder[256];
    char name[256];
} CameraFilePath;
#endif
...
typedef struct _CameraAbilities {
    int dummy;
} CameraAbilities;
typedef struct _GPPortInfo {
    int dummy;
} GPPortInfo;
static inline int gp_list_new(CameraList** l)
{
    (void)l;
    return GP_OK;
}
static inline void gp_list_reset(CameraList* l) { (void)l; }
static inline int gp_camera_autodetect(CameraList* l, GPContext* c)
{
    (void)l;
    (void)c;
    return 0;
}
static inline int gp_list_get_name(CameraList* l, int i, const char** n)
{
    (void)l;
    (void)i;
    (void)n;
...
static inline int gp_list_get_value(CameraList* l, int i, const char** v)
{
    (void)l;
    (void)i;
    (void)v;
...
static inline int gp_camera_new(Camera** c)
{
    (void)c;
    return GP_OK;
}
static inline int gp_abilities_list_new(CameraAbilitiesList** a)
{
    (void)a;
    return GP_OK;
}
static inline int gp_abilities_list_load(CameraAbilitiesList* a, GPContext* c)
{
    (void)a;
    (void)c;
    return GP_OK;
}
static inline int gp_abilities_list_lookup_model(CameraAbilitiesList* a, const char* m)
{
    (void)a;
    (void)m;
    return GP_OK;
}
static inline int gp_abilities_list_get_abilities(CameraAbilitiesList* a, int m, CameraAbilities* aa)
{
    (void)a;
    (void)m;
    (void)aa;
...
static inline int gp_camera_set_abilities(Camera* c, CameraAbilities a)
{
    (void)c;
    (void)a;
    return GP_OK;
}
static inline int gp_port_info_list_new(GPPortInfoList** l)
{
    (void)l;
    return GP_OK;
}
static inline int gp_port_info_list_load(GPPortInfoList* l)
{
    (void)l;
    return GP_OK;
}
static inline int gp_port_info_list_count(GPPortInfoList* l)
{
    (void)l;
    return GP_OK;
}
static inline int gp_port_info_list_lookup_path(GPPortInfoList* l, const char* p)
{
    (void)l;
    (void)p;
    return GP_OK;
}
static inline int gp_port_info_list_get_info(GPPortInfoList* l, int p, GPPortInfo* i)
{
    (void)l;
    (void)p;
    (void)i;
...
static inline int gp_camera_set_port_info(Camera* c, GPPortInfo i)
{
    (void)c;
    (void)i;
    return GP_OK;
}
static inline int gp_camera_capture(Camera* c, int cap, CameraFilePath* path, GPContext* ctx)
{
    (void)c;
    (void)cap;
    (void)path;
...
static inline int gp_camera_file_get(Camera* c, const char* f, const char* n, int t, CameraFile* file, GPContext* ctx)
{
    (void)c;
    (void)f;
    (void)n;
...
static inline int gp_camera_file_delete(Camera* c, const char* f, const char* n, GPContext* ctx)
{
    (void)c;
    (void)f;
    (void)n;
...
static inline int gp_file_new_from_fd(CameraFile** file, int fd)
{
    (void)file;
    (void)fd;
    return GP_OK;
}
static inline int gp_camera_exit(Camera* c, GPContext* ctx)
{
    (void)c;
    (void)ctx;
    return GP_OK;
